        ...
        <div className="-mt-80 z-20 relative">
          <div className="mx-auto max-w-7xl px-6 lg:px-8 z-20">
            <div className="mx-auto grid max-w-md grid-cols-1 gap-8 lg:max-w-4xl lg:grid-cols-2 z-20">
              ...
              >
                <motion.div
                  className="lg:min-w-0 lg:flex-1 z-30"
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }}
                  transition={{ duration: 2 }}
                >
                  <motion.h3
                    className="text-lg font-bold leading-8 tracking-tight text-green-buttonhero z-30 drop-shadow-md"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }}
                    transition={{ duration: 1.75 }}
                  >
                  ...
                  <motion.p
                    className="mt-1 text-base leading-7 text-black z-30 drop-shadow-md"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }}
                    transition={{ duration: 1.5 }}
                  >
